...
export default class AppsterView {
    ...
    loadRoot(appData) {
        ...
        if (!appsterRootDiv) {
            ...
            let appsterEditTextModal = this.buildAppsterEditInputModal();
            ...
            appsterRootDiv.appendChild(appsterEditTextModal);
    ...
    buildAppsterEditInputModal() {
        ...
        let footer = this.buildElement(     AppsterHTML.FOOTER, 
                                            ...
                                            [AppsterGUIClass.APPSTER_MODAL_FOOTER],
                                            [],
                                            AppsterText.APPSTER_TEXT_EDOT_MODAL_FOOTER_TEXT);
        p.appendChild(strong);
        section.appendChild(p);
        textFrame.appendChild(header);
        textFrame.appendChild(section);
